...
<div class="site-header">
  <div class="container-fluid">
    <div class="header-logo"> <a class="logo ir" href="${ctx}/index" title="叮咚官网"><img src="${ctxsta}/os/images/logo.png"></a> </div>
    ...
    <%--<div class="header-nav">
      <ul class="nav-list J_navMainList clearfix">
        <li id="J_navCategory" class="nav-category"> <a class="link-category" href="${ctx}/list?categoryId=1"><span class="text">全部分类</span></a>
          <!--     轮播top菜单导航begin       -->
          &lt;%&ndash;<div class="site-category">
            <ul class="site-category-list clearfix">
              <c:forEach items="${categorys}" var="category">
