  ...
  <div class="container-fluid">
    <div class="row">
      <div class="col-md-12">
        ...
        <div class="topbar-info" id="J_userInfo"><span class="user"><a rel="nofollow" class="user-name" href="${ctx}/uc/user/portal" target="_blank"><span class="name">${user.userName}</span>&nbsp;&nbsp;<i class="glyphicon glyphicon-chevron-down"></i></a>
