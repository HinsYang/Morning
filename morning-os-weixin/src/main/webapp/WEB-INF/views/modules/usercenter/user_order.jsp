                  ...
                  <table class="order-detail-table">
                    ...
                    <tr>
                      <th class="col-main"> <p class="caption-info">
                        ...
                        <a class="btn btn-small btn-primary" href="${ctx}/buy/confirm/${orderVO.orderNumber}" target="_blank">立即支付</a> <a class="btn btn-small btn-line-gray" href="${ctx}/uc/order/${orderVO.orderNumber}">订单详情</a>
                      </th>
                    </tr>
                    </thead>
                    <tbody>
                  ...
                  <table class="order-detail-table">
                    ...
                    <tr>
                      <th class="col-main"> <p class="caption-info">
                        ...
                        <span class="sep">|</span>yeungchihang<span class="sep">|</span>订单号： <a href="${ctx}/uc/order/${orderVO.orderNumber}">${orderVO.orderNumber}</a><span class="sep">|</span>在线支付</p>
                        <p class="caption-price">订单金额：<span class="num">${orderVO.payAmount}</span>元</p>
                        <c:if test="${orderVO.orderProducts[0].commentStatus == 0}"><a class="btn btn-small btn-warning" href="${ctx}/uc/order/comment/${orderVO.orderId}" target="_blank" style="color: white">去评价</a></c:if>
                        <a class="btn btn-small btn-line-gray" href="${ctx}/uc/order/${orderVO.orderNumber}">订单详情</a>
                      </th>
                    </tr>
                    </thead>
